...
$taxonomy = $category->taxonomy; //'cat-passport'
...
$id        = $term_id;
$outCountPost =  get_option('ps_per_page_passport') ?: get_option('posts_per_page');
$postType = 't-passport';
get_header();
?>
    ...
    <div class="sub-head__wrapper">
      <div class="sub-head__bg">
        ...
        <div class="sub-head__image" data-reveal="elem">
          <div class="image">
            <?php $img = get_field('cat_passport_fon', 'options'); ?>
      ...
      <div class="sub-head__content">
        <div class="sub-head__info">
          ...
          <h1 class="sub-head__title h2-title h2-title--white" data-reveal="txt"><?= get_field('cat_passport_t', 'options') ?: 'Паспорта продукции' ?></h1>
