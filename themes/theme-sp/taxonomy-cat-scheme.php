...
$taxonomy = $category->taxonomy; //'cat-scheme'
...
$id        = $term_id;
$outCountPost =  get_option('ps_per_page_scheme') ?: get_option('posts_per_page');
$postType = 't-scheme';
get_header();
?>
    ...
    <div class="sub-head__wrapper">
      <div class="sub-head__bg">
        ...
        <div class="sub-head__image" data-reveal="elem">
          <div class="image">
            <?php $img = get_field('cat_scheme_fon', 'options'); ?>
      ...
      <div class="sub-head__content">
        <div class="sub-head__info">
          ...
          <h1 class="sub-head__title h2-title h2-title--white" data-reveal="txt"><?= get_field('cat_scheme_t', 'options') ?: 'Чертежи, схемы' ?></h1>
